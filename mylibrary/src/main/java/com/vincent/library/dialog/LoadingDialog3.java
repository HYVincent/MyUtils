...
public class LoadingDialog3 {
    ...
    private static final String TAG = LoadingDialog3.class.getSimpleName();
    ...
    private static Dialog createLoadingDialog(Activity activity) {
        View view = LayoutInflater.from(activity).inflate(R.layout.dialog_loading_3, null);// 得到加载view;
        LinearLayout layout =  view.findViewById(R.id.dialog_loading_view_3);// 加载布局
        tvMsg = view.findViewById(R.id.loading_dialog_tv_msg_3);
        if(dialog == null){
